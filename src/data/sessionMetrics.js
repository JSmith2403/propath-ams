...
export const METRIC_CATEGORIES = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { key: 'hamstring0',          label: 'Hamstring 0°',             unit: 'kg', bilateral: true,  attempts: 1 },
      { key: 'hamstring30',         label: 'Hamstring 30°',            unit: 'kg', bilateral: true,  attempts: 1 },
      { key: 'hamstring90',         label: 'Hamstring 90°',            unit: 'kg', bilateral: true,  attempts: 1 },
      { key: 'hipFlexionSupine90',  label: 'Hip Flexion Supine 90°',   unit: 'kg', bilateral: true,  attempts: 1 },
      { key: 'hipExtensionProne90', label: 'Hip Extension Prone 90°',  unit: 'kg', bilateral: true,  attempts: 1 },
      { key: 'adduction0',          label: 'Adduction 0°',             unit: 'kg', bilateral: true,  attempts: 1 },
      { key: 'adduction90',         label: 'Adduction 90°',            unit: 'kg', bilateral: true,  attempts: 1 },
  ...
  },
  {
    ...
    label: 'Capacity',
    metrics: [
      { key: 'slBridgeCapacity', label: 'Single Leg Bridge Capacity', unit: 's',    bilateral: true,  attempts: 1 },
  ...
  },
  {
    ...
    metrics: [
      ...
      { key: 'yoyoIR',    label: 'Yo-Yo IR1/IR2', unit: 'level',     bilateral: false, attempts: 1 },
      { key: 'bleepTest', label: 'Bleep Test',    unit: 'level',     bilateral: false, attempts: 1 },
    ],
  },
  {
    key: 'cognitive',
    ...
    metrics: [
      ...
      { key: 'processingSpeed', label: 'Processing Speed', unit: 'ms',    bilateral: false, attempts: 1 },
    ],
  },
];
